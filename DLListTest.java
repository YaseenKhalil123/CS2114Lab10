...
/**
 * This class is used to test the DLlist Class
 * 
 * @author Eric
 * @author maellis1
 * @version 11-2-15
...
public class DLListTest extends TestCase {
    ...
    /**
     * Tests the has next then the next function itself
     */
    public void testIteratorHasNextAndNextFunction() {
        list.add("a");
        list.add("b");
        list.add("c");
    ...
    /**
     * Tests if the iterator will throw an exception coreectly
     */
    ...
    /**
     * tests iterator on an empty dlist
     */
    public void testIteratorEmpty() {
        DLList<Integer> emptyDlList = new DLList<Integer>();
        Iterator<Integer> iterator = emptyDlList.iterator();
        assertFalse(iterator.hasNext());
    }


    /**
     * tests traversing a dlist using an iterator
     */
    public void testIteratorTraversal() {
        ...
        assertEquals((Object)Integer.valueOf(1), iterator.next());
        assertTrue(iterator.hasNext());
        assertEquals((Object)Integer.valueOf(2), iterator.next());
        assertTrue(iterator.hasNext());
        assertEquals((Object)Integer.valueOf(3), iterator.next());
    }


    /**
     * tests that the remove doesnt work
     */
    ...
    /**
    * Problem coverage test for post lab
    */
