...
public class DLList<E> implements Iterable<E> {
     ...
     * -------------------------------------------------------------------------
     * /**
     * An iterator that we will use for the DLList
     * 
     * @author yaseenkhalil
     * @version Nov 2, 2025
     */
    private class DLListIterator implements Iterator<E> {
         ...
         * // ----------------------------------------------------------
         * /**
         * Create a new DLListIterator object.
         */
        ...
        /**
         * checks if there is a nexxt node
         */
        @Override
        ...
        public E next() {
            if (!hasNext()) {
                throw new NoSuchElementException("This is the last elemnt");
            }
            E element = nextNode.data;
        ...
        /**
         * remove method which should not work
         */
        @Override
        public void remove() {
